...
import { FileIcon, FolderIcon, FolderOpenIcon, Plus, Minus } from "lucide-react"
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            `flex items-center gap-1 text-sm rounded-md px-1 py-0.5`,
            className,
            {
        ...
        >
          ...
          <button
            ...
            className="hover:bg-accent rounded p-0.5 focus:outline-none"
          >
            {isExpanded
          ...
          {/* Folder icon and name - selects the folder */}
          <div 
