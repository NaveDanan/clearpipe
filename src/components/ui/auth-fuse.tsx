...
function AuthFormContainer({ isSignIn, onToggle, handlers, isLoading, error }: AuthFormContainerProps) {
  return (
    <div className="mx-auto grid w-[350px] gap-2">
      {isSignIn ? (
        <SignInForm 
          onSubmit={handlers.onSignIn || (async () => {})} 
          isLoading={isLoading}
          error={error}
        />
      ) : (
        <SignUpForm 
          onSubmit={handlers.onSignUp || (async () => {})} 
          isLoading={isLoading}
          error={error}
        />
      )}
      <div className="text-center text-sm">
        ...
        <Button variant="link" className="pl-1 text-foreground" onClick={onToggle} disabled={isLoading}>
      ...
      <div className="grid gap-2">
        {handlers.onGoogleSignIn && (
          <Button variant="outline" type="button" onClick={handlers.onGoogleSignIn} disabled={isLoading}>
        ...
        {handlers.onGitHubSignIn && (
          <Button variant="outline" type="button" onClick={handlers.onGitHubSignIn} disabled={isLoading}>
...
const defaultSignUpContent = {
  image: {
    src: "https://images.unsplash.com/photo-1557672172-298e090bd0f1?q=80&w=1974&auto=format&fit=crop",
    alt: "Abstract colorful flowing art",
  },
  quote: {
